...
// Package propagation implement X-Cloud-Function-Trace-Context header propagation used
// by Google Cloud products.
package propagation // import "github.com/kelseyhightower/functions/propagation"
...
const (
	...
	httpHeader        = `X-Cloud-Function-Trace-Context`
)


// SpanContextFromRequest extracts a Stackdriver Trace span context from incoming requests.
func SpanContextFromRequest(req *http.Request) (sc trace.SpanContext, ok bool) {
